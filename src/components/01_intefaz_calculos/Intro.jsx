...
function Intro() {
  return (
    <>
      <p className="w-[75%] m-auto mt-[90px] text-xs text-slate-700 dark:text-slate-300 mb-2">
        Tener en cuenta las siguientes consideraciones:
      </p>
      <div className="flex w-[75%] m-auto space-x-2  max-[425px]:space-y-2  max-[425px]:flex-col max-[425px]:space-x-0 max-[425px]:items-center">
