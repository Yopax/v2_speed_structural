...
function AboutOne() {
  return (
    <div className=" max-[425px]:w-[80%] max-[425px]:mb-[50px] max-[425px]:mr-0 max-[1024px]:h-[400px] max-[768px]:h-[400px] justify-center bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-gray-500 via-white to-white flex flex-col items-center  bg-white-200 w-[20%] text-center h-[380px] mr-10 rounded-lg shadow-2xl">
          <img
          ...
          <div className="flex flex-col ">
            ...
            <Link href="https://cv-barreto.vercel.app/">
